...
document.addEventListener('DOMContentLoaded', function (event) {
  console.log("Current userId: ".concat(window.userId));
  Echo["private"]("notifications.user.".concat(window.userId)).notification(function (notification) {
    console.log(notification);
  });

  document.querySelector('[data-action="create-product"]').onclick = function (e) {
    axios.get(route('product.create', 1));
  };

  document.querySelector('[data-action="create-news"]').onclick = function (e) {
...
window.Echo = new laravel_echo__WEBPACK_IMPORTED_MODULE_0__.default({
  ...
  host:  true ? "".concat(window.location.hostname, ":").concat("6001") : 0,
